...
class EventsController {
	...
	insertEvent(
		...
		return new Promise(async (resolve, reject) => {
			try {
				const newEvent = await this.model.createEvent(
					promoterid,
					details,
					price,
					location,
	...
	editEvent(
		...
		return new Promise(async (resolve, reject) => {
			try {
				const propsToEdit = [
					{ value: id, propName: 'id' },
					{ value: promoterid, propName: 'promoterid' },
					{ value: details, propName: 'details' },
					{ value: price, propName: 'price' },
					{ value: location, propName: 'location' },
					{ value: photo, propName: 'photo' },
