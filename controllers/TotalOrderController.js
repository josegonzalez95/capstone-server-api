...
class TotalOrderController {
    ...
    */
    insertTotalOrder(participants, paymentMethod, orderCreatorEmail, eventId){
        return new Promise(async(resolve, reject) => {
            try {
                const newOrder = await this.model.createOrder(participants, paymentMethod, orderCreatorEmail, eventId)
